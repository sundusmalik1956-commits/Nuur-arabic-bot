...
<level>/lessonN.py (مثل a1/lesson1.py أو b2/lesson7.py) حتى يعمل مع lesson_engine.py تلقائيًا.

المستويات المدعومة كمجلدات: a0, a1, a2, b1, b2 — كل مجلد يحتوي lesson1.py وحتى
lesson18.py (a0 يحتوي فقط lesson1.py حتى lesson4.py، حسب مواصفات المستوى).
